...
if __name__ == "__main__":
    pi = math.pi
    card_list_ = [[[150.,275.,15.],[pi,0.,0.],0.],
                  [[150.,-275.,15.],[pi,0.,0.],19.],
                  [[500.,495.,800.],[pi/2,-pi/2,pi],21.],
                                [[380.,495.,600.],[pi/2,-pi/2,pi],8.],
                                [[600.,495.,300.],[pi/2,-pi/2,pi],1.],
                                [[300.,495.,825.],[pi/2,-pi/2,pi],5.],
                                [[300.,-530.,200.],[pi/2,-pi/2,0.],17.],
                                [[450.,-530.,500.],[pi/2,-pi/2,0.],29.],
                                [[620.,-530.,200.],[pi/2,-pi/2,0.],20.],
                                [[620.,-530.,800.],[pi/2,-pi/2,0.],13.]]
